    ...
    <div>
      ...
      <div className="card mb-8">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="text-xs text-slate-400">Click an event to register (if eligible)</div>
        </div>
        <FullCalendar 
        ...
        {upcomingEvents.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {upcomingEvents.map(event => (
              <div key={event.id} className="border border-slate-700 rounded-lg p-4 hover:shadow-md transition-shadow bg-slate-900 border border-slate-800 rounded-lg p-4">
